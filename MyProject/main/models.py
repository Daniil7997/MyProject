...
class UserList(models.Model):
    ...
    time_register = models.DateTimeField(auto_now_add=True, verbose_name='Время регистрации')
...
def path_to_user_directory(instance, filename): # https://www.geeksforgeeks.org/python/imagefield-django-models/
